...
namespace AutoLot.Dal.EfStructures.Migrations
{
    ...
    [Migration("20251122232502_CustomSql")]
            ...
            modelBuilder.Entity("AutoLot.Models.Entities.CarDriver", b =>
                {
                    ...
                    b.HasIndex(new[] { "DriverId", "CarId" }, "IX_InventoryToDrivers_DriverId_CarId")
                        .IsUnique();
            ...
            modelBuilder.Entity("AutoLot.Models.Entities.Driver", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "PersonInformation", "AutoLot.Models.Entities.Driver.PersonInformation#Person", b1 =>
                        {
                            b1.IsRequired();
