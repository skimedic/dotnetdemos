...
// ==================================
// AutoLot8 - AutoLot.Mvc - ItemLinkTagHelperBase.cs
    ...
    IUrlHelperFactory urlHelperFactory) : TagHelper
{
    ...
    private readonly string _controllerName = contextAccessor.ActionContext.ActionDescriptor.RouteValues["controller"];
