...
// ==================================
// EFCoreExamples - 01_PerformanceEf6 - TestEf6.cs
...
public static class TestEf6
{
    ...
    public static void AddRecordsAndSave()
    {
        using (var db = new AdventureWorksContext())
        {
            ...
            {
                db.ProductCategories.Add(new ProductCategory {rowguid = Guid.NewGuid(), Name = $"Test {Guid.NewGuid()}",ModifiedDate = DateTime.Now});
            }
            db.SaveChanges();
        }
    }
