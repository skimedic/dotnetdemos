...
// ==================================
// AutoLot-WebApps - AutoLot.Models - CarDriverConfiguration.cs
...
public class CarDriverConfiguration : IEntityTypeConfiguration<CarDriver>
{
        ...
        EntityTypeBuilder<CarDriver> builder)
    {
        ...
        builder.HasQueryFilter(
            CarConfiguration.IsNewQueryFilterName,
            c =>
            c.CarNavigation.DateBuilt > new DateTime(
                2020,
                1,
                1));
        builder.ToTable(tb =>
