...
public class CarDriverConfiguration : IEntityTypeConfiguration<CarDriver>
{
    public void Configure(
        EntityTypeBuilder<CarDriver> builder)
    {
        builder.HasIndex(e =>
            new
            {
        ...
        builder.HasOne(e => e.DriverNavigation).WithMany(d => d.CarDrivers).HasForeignKey(e => e.DriverId);
        builder.HasOne(e => e.CarNavigation).WithMany(c => c.CarDrivers).HasForeignKey(e => e.CarId);
